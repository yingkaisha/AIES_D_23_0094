...
prefix = '/glade/work/ksha/NCAR/VALID_lead_inds_{}{}{}{}_part{}_v4x.npy'
...
for lead1_base in range(2, 21):
    ...
    np.save('/glade/work/ksha/NCAR/IND_VALID_lead_{}{}{}{}_v4x.npy'.format(lead1_base, lead2_base, lead3_base, lead4_base), IND_VALID_lead)
    print('/glade/work/ksha/NCAR/IND_VALID_lead_{}{}{}{}_v4x.npy'.format(lead1_base, lead2_base, lead3_base, lead4_base))
