...
# import filenames
filenames = np.load('/glade/work/ksha/NCAR/filenames_for_VALID_inds_v4x.npy', allow_pickle=True)[()]
...
for lead1_base in range(2, 21):
    ...
    filename_valid_lead2 = filenames['lead{}'.format(lead1_base)]
    filename_valid_lead3 = filenames['lead{}'.format(lead2_base)]
    filename_valid_lead4 = filenames['lead{}'.format(lead3_base)]
    filename_valid_lead5 = filenames['lead{}'.format(lead4_base)]
    ...
    np.save('/glade/work/ksha/NCAR/VALID_lead_inds_{}{}{}{}_part{}_v4x.npy'.format(lead1_base, lead2_base, lead3_base, lead4_base, part), save_dict)
    print('/glade/work/ksha/NCAR/VALID_lead_inds_{}{}{}{}_part{}_v4x.npy'.format(lead1_base, lead2_base, lead3_base, lead4_base, part))
