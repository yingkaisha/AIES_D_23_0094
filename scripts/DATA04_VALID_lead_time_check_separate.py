...
# import filenames
filenames = np.load('/glade/work/ksha/NCAR/filenames_for_VALID_inds.npy', allow_pickle=True)[()]
...
for lead1_base in range(2, 21):
    ...
    np.save('/glade/work/ksha/NCAR/VALID_lead_inds_{}{}{}{}_part{}.npy'.format(lead1_base, lead2_base, lead3_base, lead4_base, part), save_dict)
    print('/glade/work/ksha/NCAR/VALID_lead_inds_{}{}{}{}_part{}.npy'.format(lead1_base, lead2_base, lead3_base, lead4_base, part))
