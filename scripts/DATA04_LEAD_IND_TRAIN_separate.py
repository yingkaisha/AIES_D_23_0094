...
prefix = '/glade/work/ksha/NCAR/TRAIN_lead_inds_{}{}{}{}_part{}.npy'
...
for lead1_base in range(2, 21):
    ...
    np.save('/glade/work/ksha/NCAR/IND_TRAIN_lead_{}{}{}{}.npy'.format(lead1_base, lead2_base, lead3_base, lead4_base), IND_TRAIN_lead)
    print('/glade/work/ksha/NCAR/IND_TRAIN_lead_{}{}{}{}.npy'.format(lead1_base, lead2_base, lead3_base, lead4_base))
