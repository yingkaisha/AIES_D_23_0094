...
save_round = 5
seeds = 123456
model_de_load = 'GAN_de{}_skew_wild'.format(weights_round) #False
model_gen_load = 'GAN_gen{}_skew_wild'.format(weights_round) #False

model_de_save = 'GAN_de{}_skew_wild'.format(save_round) #False
model_gen_save = 'GAN_gen{}_skew_wild'.format(save_round) #False
